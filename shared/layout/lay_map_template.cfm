...
<html lang="en">
	<head>
			...
			<cfif variables.qArtefacts.recordcount>
				...
				arrMarkers = [
					<cfoutput query="variables.qArtefacts">
						...
						<cfelseif structKeyExists(variables.qArtefacts, "strCategoryName") AND len(variables.qArtefacts.strCategoryName)>
							<cfset variables.strGooglePinName	= variables.qArtefacts.strCategoryName>
						<cfelse>
							<cfset variables.strGooglePinName	= "">
						</cfif>
						</cfsilent>
						{ lat: #variables.qArtefacts.gpsLatitude#, lng: #variables.qArtefacts.gpsLongitude#, name: "#variables.strGooglePinName#", artId: #variables.qArtefacts.intArtefactId#, mapIcon: "#variables.qArtefacts.strJsIconName#" }
		...
		<cfoutput>
			...
			<script type="text/javascript" src="#application.stuHeaders.strNoisyMaps#"></script>
